...
# Dataset, 
# write down in order what you think is happening
# Getting dataset, getting a column title, getting another column title, then getting what rows to take that data from to put under those new headings
# what other arguements might be useful
# na.rm
